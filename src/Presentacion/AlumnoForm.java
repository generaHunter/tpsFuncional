...
public class AlumnoForm extends javax.swing.JFrame {
    ...
    Encargado NEncargado = new Encargado();  
    Alumno AlumnoEdit;
    ...
    public Alumno llenarEntidadAlumno() 
    {
        try {
    ...
    private void initComponents() {
        ...
        tablaAlumno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Fecha_nac", "Encargado", "ID Encargado"
            }
        ) {
...
//                 
        ...
        public void caracteres(java.awt.event.KeyEvent evento) {
        ...
        if (evento.getKeyChar() >= 33 && evento.getKeyChar() <= 64
            ...
            evento.consume();
            JOptionPane.showMessageDialog(rootPane, "Solo debe ingresar letras");
    ...
    private javax.swing.JComboBox<Encargado> cbEncargado;
